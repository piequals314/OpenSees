...
uniaxialMaterial Hardening  2 $Es $Fy   $Hiso  $Hkin
...
puts "Pre section"  
  section taperedFiberSec  $SecTag -hRatio 1.0 -hVal 1.0 -G $Gs -v $nu {
	 ...
	 #TaperedFiber yLoc zLoc area matTag plateMatTag tP plFlaCg
     fiber         0.0   0.0  1.0  $matIDhard  2  1.0  1
	 fiber         0.0   0.0  1.0  $matIDhard  2  1.0  2
	 fiber         0.0   0.0  1.0  $matIDhard  2  1.0  3
  }
puts "Post section"  
...
element TapereddispBeamColumnS 	1 1 2    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	2 2 3    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	3 3 4    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	4 4 5    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	5 5 6    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	6 6 7    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	7 7 8    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	8 8 9    $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	9 9 10   $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	10 10 11 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	11 11 12 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	12 12 13 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	13 13 14 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	14 14 15 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	15 15 16 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	16 16 17 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	17 17 18 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	18 18 19 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	19 19 20 $numIP $SecTag3D $ColTransfTag ;
element TapereddispBeamColumnS 	20 20 21 $numIP $SecTag3D $ColTransfTag ;
