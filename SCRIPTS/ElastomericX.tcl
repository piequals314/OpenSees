...
element ElastomericX 1 1 2 $Fy_h $uy_h $G $K $D1 $D2 $ts $tr $n 0 1 0 1 0 0 $kc $PhiM $ac 0.5 0.0 $cd $tc
#-------------------------------------------------------------------------------------------------
#Define loads
#-------------------------------------------------------------------------------------------------
...
#puts [nodeDisp 2 2]
#puts $Tr
if {([nodeDisp 2 1] == $Tr) && ([nodeDisp 2 2] == -0.00349487769341271960)} { puts "SUCCESS"} else {puts "FAILURE"}
