...
#include <LinearCrdTransf3d22.h>  // Added for Tapered Study
#include <PDeltaCrdTransf3d22.h>  // Added for Tapered Study
#include <CorotCrdTransf3d22.h>   // Added for Tapered Study
  ...
  
{
  ...
  // Brighton Laiman: University of California, San Diego
      ...
      // ADDED IN FOR TAPERED STUDY

      if (strcmp(argv[1], "Linear22") == 0)
          crdTransf3d = new LinearCrdTransf3d22(crdTransfTag, vecxzPlane);

      else if (strcmp(argv[1], "PDelta22") == 0)
          crdTransf3d = new PDeltaCrdTransf3d22(crdTransfTag, vecxzPlane);

      else if (strcmp(argv[1], "Corotational22") == 0)
          crdTransf3d = new CorotCrdTransf3d22(crdTransfTag, vecxzPlane, jntOffsetI, jntOffsetJ);

      // END OF CODE ADDITIONS

      else {
          opserr << "WARNING TclElmtBuilder - addGeomTransf22 - invalid Type (DOF 7)\n";
          return TCL_ERROR;
      }

      if (crdTransf3d == 0) {
          opserr << "WARNING TclElmtBuilder - addGeomTransf22 - ran out of memory to create geometric transformation object\n";
          return TCL_ERROR;
      }
